...
class Mapper implements \ArrayAccess, \IteratorAggregate {
    ...
    private $baseMap = array(
        'renderer' => '\Ninja\Mapper\Converter\String',
        'matchMap' => array()
    );
     ...
     * @return \Ninja\Mapper\Reader\CSV
     *
     * @author David Mann <ninja@codingninja.com.au>
     */
    ...
    protected function getReaderForType($ext) {
        return new \Ninja\Mapper\Mapper\XMLMapper();
    }
    ...
    /**
     * Enter description here ...
     * @return Ambigous <\Ninja\Mapper\Ambigous, unknown_type, multitype:, multitype:unknown >
     */
     ...
     * @return \Ninja\Mapper\Mapper|multitype:
     *
     * @author David Mann <ninja@codingninja.com.au>
     */
