...
namespace Ninja\Mapper\Mapper;


class Map implements \ArrayAccess, \IteratorAggregate
{
    public static $converters = array(
        self::CONVERTER_STANDARDISER => array('\Ninja\Mapper\Mapper\Map\Standardiser\MapBasicStandardiser'),
        self::CONVERTER_STRING => array('\Ninja\Mapper\Converter\StringConverter')
    );
